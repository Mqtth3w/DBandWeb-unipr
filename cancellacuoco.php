...
<body>
	...
	<?php //cancello il cuoco
		...
		$query1=str_replace("#nome#",$cuoco,"delete from piatti where autore like '#nome#'");
		$query2=str_replace("#nome#",$cuoco,"delete from cuochi where nome like '#nome#'");
